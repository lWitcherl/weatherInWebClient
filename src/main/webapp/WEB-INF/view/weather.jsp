                ...
                <div class="u-container-layout u-valign-top u-container-layout-2">
                  <div class="u-container-style u-group u-group-1">
                    <div class="u-container-layout u-container-layout-3">
                      <h2 class="u-align-center u-text u-text-palette-1-light-2 u-text-1">${weather.name}</h2>
                      <h3 class="u-align-center u-text u-text-grey-40 u-text-2">${weather.time}</h3>
                      <h4 class="u-align-center u-text u-text-grey-15 u-text-3">Температура&nbsp;${weather.temp}</h4>
                      <h4 class="u-align-center u-text u-text-grey-15 u-text-4">По ощущениям ${weather.feelsLike}</h4>
                  ...
                  <div class="u-container-style u-group u-group-2">
                    <div class="u-container-layout u-container-layout-4">
                      ...
                      <h4 class="u-align-center u-text u-text-grey-15 u-text-6">${weather.weather}</h4>
                    </div>
                  </div>
                </div>
              </div>
